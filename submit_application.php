<?php
	...
	$to = 'james@cruisewageexchange.com';
	//$to = 'simon@simoncoulton.co.uk';
	$subject = 'Cruisewage Exchange Application';
	$body = "First Name: " . $_POST['fname'] . "\nInitial: " . $_POST['initial'] . "\nLast Name: " . $_POST['lname'] . "\nCompany: " . $_POST['company'] . "\nTel No: " . $_POST['tel'] . "\nMobile No: " . $_POST['mobile'] . "\nFax No: " . $_POST['fax'] . "\nAdd 1: " . $_POST['add1'] . "\nAdd 2: " . $_POST['add2'] . "\nAdd 3: " . $_POST['add3'] . "\nCity: " . $_POST['city'] . "\nCounty: " . $_POST['county'] . "\nPost Code: " . $_POST['postcode'] . "\nCountry: " . $_POST['country'] . "\nCruise Company: " . $_POST['cruise'] . "\nJob Title: " . $_POST['title'] . "\nPassport No: " . $_POST['passport'] . "\nAmount wished to trade: " . $_POST['amount'];
...
<body>
    ...
    <div class="content">
    	<div class="columns">
        	<div style="width: 550px; position: absolute; left: 100px; top: 30px;">
        		<h2>Thank you</h2>
                Thank you for your application. One of our team will action this as soon as they are available to.
                <br /><br />
                <br /><br />
                <br />
                <br />
